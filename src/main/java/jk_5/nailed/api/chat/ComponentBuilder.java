 ...
 * be {@link jk_5.nailed.api.chat.ChatColor#RED} and "World" would be
 * {@link jk_5.nailed.api.chat.ChatColor#BLUE} but "!" would be bold and
 * {@link jk_5.nailed.api.chat.ChatColor#BLUE} because append copies the previous
 * part's formatting
 * </p>
 */
public class ComponentBuilder {
     ...
     */
    @Nonnull
    public ComponentBuilder(@Nonnull String text) {
     ...
     */
    @Nonnull
    public ComponentBuilder append(@Nonnull String text) {
        Checks.notNull(text, "text");
        parts.add(current);
     ...
     */
    @Nonnull
    public ComponentBuilder color(@Nonnull ChatColor color) {
     ...
     */
    @Nonnull
    public ComponentBuilder event(@Nonnull ClickEvent clickEvent) {
        Checks.notNull(clickEvent, "clickEvent");
     ...
     */
    @Nonnull
    public ComponentBuilder event(@Nonnull HoverEvent hoverEvent) {
        Checks.notNull(hoverEvent, "hoverEvent");
