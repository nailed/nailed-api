...
public class TranslatableComponent extends BaseComponent {
     ...
     *                  {@link jk_5.nailed.api.chat.BaseComponent}s to use into the
     *                  translation
     * @see #translate
     * @see #setWith(java.util.List)
     */
    public TranslatableComponent(@Nonnull String translate, Object... with) {
        Checks.notNull(translate, "translate");
     ...
     */
    public void addWith(@Nonnull String text) {
    ...
    @Override
    protected void toPlainText(@Nonnull StringBuilder builder) {
    ...
    @Override
    protected void toLegacyText(@Nonnull StringBuilder builder) {
        Checks.notNull(builder, "builder");
        try{
            String trans = locales.getString(translate);
            Matcher matcher = format.matcher(trans);
    ...
    private void addFormat(@Nonnull StringBuilder builder) {
    ...
    public void setTranslate(@Nonnull String translate) {
        this.translate = Checks.notNull(translate, "translate");
    }
