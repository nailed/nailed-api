...
public interface Messenger {
     ...
     */
    void registerOutgoingPluginChannel(PluginIdentifier plugin, String channel); //TODO: event for this
     ...
     * @throws IllegalArgumentException Thrown if plugin or channel is null.
     */
    void unregisterOutgoingPluginChannel(PluginIdentifier plugin, String channel);
     ...
     */
    void unregisterOutgoingPluginChannel(PluginIdentifier plugin);
     ...
     */
    PluginMessageListenerRegistration registerIncomingPluginChannel(PluginIdentifier plugin, String channel, PluginMessageListener listener);
     ...
     *     is null.
     */
    void unregisterIncomingPluginChannel(PluginIdentifier plugin, String channel, PluginMessageListener listener);
     ...
     * @throws IllegalArgumentException Thrown if plugin or channel is null.
     */
    void unregisterIncomingPluginChannel(PluginIdentifier plugin, String channel);
     ...
     * @throws IllegalArgumentException Thrown if plugin is null.
     */
    void unregisterIncomingPluginChannel(PluginIdentifier plugin);
     ...
     * @throws IllegalArgumentException Thrown if plugin is null.
     */
    Set<String> getOutgoingChannels(PluginIdentifier plugin);
     ...
     * @throws IllegalArgumentException Thrown if plugin is null.
     */
    Set<String> getIncomingChannels(PluginIdentifier plugin);
     ...
     * @throws IllegalArgumentException Thrown if plugin is null.
     */
    Set<PluginMessageListenerRegistration> getIncomingChannelRegistrations(PluginIdentifier plugin);
     ...
     * @throws IllegalArgumentException Thrown if plugin or channel is null.
     */
    Set<PluginMessageListenerRegistration>  getIncomingChannelRegistrations(PluginIdentifier plugin, String channel);
     ...
     */
    boolean isIncomingChannelRegistered(PluginIdentifier plugin, String channel);
     ...
     * @return True if the channel is registered, else false.
     */
    boolean isOutgoingChannelRegistered(PluginIdentifier plugin, String channel);
