package jk_5.nailed.api.text.title;
...
public class TitleBuilder {
    ...
    /**
     * Constructs a new empty {@link jk_5.nailed.api.text.title.TitleBuilder}.
     */
    public TitleBuilder() {
    }

    /**
     * Constructs a new {@link jk_5.nailed.api.text.title.TitleBuilder} with the properties of the given
     ...
     *
     * @return The current main title, or {@link com.google.common.base.Optional#absent()} if none
     * @see Title#getTitle()
     */
     ...
     *
     * @return The current subtitle, or {@link com.google.common.base.Optional#absent()} if none
     ...
     *
     * @return The current fade in time, or {@link com.google.common.base.Optional#absent()} if none
     * @see Title#getFadeIn()
     */
     ...
     *
     * @return The current stay time, or {@link com.google.common.base.Optional#absent()} if none
     * @see Title#getStay()
     */
     ...
     *
     * @return The current fade out time, or {@link com.google.common.base.Optional#absent()} if none
