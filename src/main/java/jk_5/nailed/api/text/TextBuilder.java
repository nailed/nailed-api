...
import jk_5.nailed.api.text.action.ClickAction;
import jk_5.nailed.api.text.action.HoverAction;
import jk_5.nailed.api.text.action.ShiftClickAction;
import jk_5.nailed.api.text.format.TextColor;
import jk_5.nailed.api.text.format.TextColors;
import jk_5.nailed.api.text.format.TextStyle;
import jk_5.nailed.api.text.format.TextStyles;
import jk_5.nailed.api.text.translation.Translation;
...
public abstract class TextBuilder {
    ...
    public static class Translatable extends TextBuilder {
         ...
         * the given {@link jk_5.nailed.api.text.translation.Translatable}
         * .
         *
         * @param translatable The translatable for the builder
         * @param args The arguments for the translation
         */
        public Translatable(jk_5.nailed.api.text.translation.Translatable translatable, Object... args) {
         ...
         * {@link jk_5.nailed.api.text.translation.Translatable}.
         *
         * @param text The text to apply the properties from
         * @param translatable The translatable for the builder
         * @param args The arguments for the translation
         */
        public Translatable(Text text, jk_5.nailed.api.text.translation.Translatable translatable, Object... args) {
            super(text);
            translation(translatable, args);
        }
         ...
         * @return This text builder
         */
        public Translatable translation(jk_5.nailed.api.text.translation.Translatable translatable, Object... args) {
    ...
    public static class Selector extends TextBuilder {
        ...
        protected jk_5.nailed.api.text.selector.Selector selector;
         ...
         */
        public Selector(jk_5.nailed.api.text.selector.Selector selector) {
            selector(selector);
        }
         ...
         * @param selector The selector for the builder
         */
        public Selector(Text text, jk_5.nailed.api.text.selector.Selector selector) {
            super(text);
            selector(selector);
        }
         ...
         */
        public final jk_5.nailed.api.text.selector.Selector getSelector() {
         ...
         * @see Text.Selector#getSelector()
         */
        public Selector selector(jk_5.nailed.api.text.selector.Selector selector) {
