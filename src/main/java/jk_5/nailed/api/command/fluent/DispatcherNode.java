...
public class DispatcherNode {
     ...
     * Set the description.
     * 
     * <p>This can only be used on {@link jk_5.nailed.api.command.fluent.DispatcherNode}s returned by
     * {@link #group(String...)}.</p>
     * 
     ...
     * return to this "parent" context, use {@link jk_5.nailed.api.command.fluent.DispatcherNode#graph()}.</p>
     * 
     * @param alias the list of aliases, where the first alias is the primary one
